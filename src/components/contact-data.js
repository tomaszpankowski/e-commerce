    ...
    render(){
        ...
        return(        
            <Container fluid className={"contact-s1 align-items-center p-0 d-flex minh-50vh "+this.props.classExt}>
                <Row className="mx-auto text-start text-md-center w-100 mt-5">
                    <Col xs={12} md={5} className="text-secondary p-0 d-flex align-items-center">
                        <div className="p-5">
                            ...
                            <address className="d-block w-50 ms-0 mx-md-auto p-2 mb-4 initialism text-start text-md-center">
                                00-001 City,<br/> 
                                Street 12A,<br/>
                                678 142 838<br/>
                                contact&#64;mail.it
